...
OMP_NUM_THREADS=4 CUDA_VISIBLE_DEVICES=0,1 /rhome/abokhovkin/miniconda3/envs/textures/bin/python -u trainer/train_car_nocs.py wandb_main=True val_check_interval=10 experiment=cars_shapenet_nocs_effnetb4_lr0.00005 lr=0.00005 sanity_steps=0 image_size=512 batch_size=64
